...
const CreateGame = () => {
  ...
  return (<>
    ...
    <Form onSubmit={onSubmit}>
      <Form.Label>Looks like you'd like to challenge your friends to a game of Wordguessr! Enter the amount of rounds you'd like your friends to play</Form.Label>
      <S.FormContainer>
